...
(function (factory) {
    ...
    $.extend(true, DataTable.ext.classes, {
        ...
        thead: {
            row: 'dark:border-gray-700/50 border-b border-black',
            cell: 'px-3 py-[10px] text-gray-900 bg-neutral-100 font-semibold text-left dark:text-gray-50 dark:bg-gray-700/25'
        },
        tbody: {
            row: 'even:bg-white dark:even:bg-gray-900/50',
            cell: 'p-3'
        },
